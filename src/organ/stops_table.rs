...
pub enum OrganStop {
    ...
    ChoirTuba8 = 98,
    // 99 is deliberately not in the list
    // 100 is deliberately not in the list
    PedalGreatToPedal = 101,
    PedalChoirToPedal = 102,
    PedalDoubleOpenWood32 = 103,
    PedalOpenMetal16 = 104,
    PedalOpenWoodI16 = 105,
    PedalOpenWoodII16 = 106,
    PedalViolone16 = 107,
    PedalBourdon16 = 108,
    PedalQuintaten16 = 109,
    PedalViola16 = 110,
    PedalDulciana16 = 111,
    PedalOctaveMetal8 = 112,
    PedalPrincipal8 = 113,
    PedalOctaveWood8 = 114,
    PedalFlute8 = 115,
    PedalOctaveQuint5_1_3 = 116,
    PedalSuperOctave4 = 117,
    PedalFifteenth4 = 118,
    PedalOctaveFlute4 = 119,
    PedalMixtureIV = 120,
    PedalDoubleOphicleide32 = 121,
    PedalOphicleide16 = 122,
    PedalTrombone16 = 123,
    PedalFagotto16 = 124,
    PedalPosaune8 = 125,
    PedalOctavePosaune4 = 126,
}

impl OrganStop {
    pub fn from_u8(value: u8) -> Option<Self> {
        match value {
            0 => Some(Self::PedalSwellToPedal),
            1 => Some(Self::PedalSoloToPedal),
            3 => Some(Self::SoloContraViola16),
            4 => Some(Self::SoloVioleDOrchestre8),
            5 => Some(Self::SoloVioleCeleste8),
            6 => Some(Self::SoloVioleSourdine8),
            7 => Some(Self::SoloVioleOctaviante4),
            8 => Some(Self::SoloCornetDeViolesIII),
            9 => Some(Self::SoloTuba8),
            10 => Some(Self::SoloTubaClarion4),
            11 => Some(Self::SoloSpareAStopLine),
            12 => Some(Self::SoloSpareBStopLine),
            13 => Some(Self::SoloTremulant),
            14 => Some(Self::SwellTremulant),
            15 => Some(Self::ChoirTremulant),
            16 => Some(Self::ChoirSubOctave),
            17 => Some(Self::ChoirUnisonOff),
            18 => Some(Self::ChoirOctave),
            19 => Some(Self::SoloHarmonicFlute8),
            20 => Some(Self::SoloConcertFlute4),
            21 => Some(Self::SoloHarmonicPiccolo2),
            22 => Some(Self::SoloOrchestralOboe8),
            23 => Some(Self::SoloCorAnglais8),
            24 => Some(Self::SoloFrenchHorn8),
            25 => Some(Self::SoloOrchestralTrumpet8),
            26 => Some(Self::SwellSoloToSwell),
            27 => Some(Self::SoloSubOctave),
            28 => Some(Self::SoloUnisonOff),
            29 => Some(Self::SoloOctave),
            30 => Some(Self::SwellQuintaten16),
            31 => Some(Self::SwellOpenDiapason8),
            32 => Some(Self::SwellViolinDiapason8),
            33 => Some(Self::SwellLieblichGedackt8),
            34 => Some(Self::SwellEchoGamba8),
            35 => Some(Self::SwellVoixCelestes8),
            36 => Some(Self::SwellPrincipal4),
            37 => Some(Self::SwellLieblichFlute4),
            38 => Some(Self::SwellTwelfth2_2_3),
            39 => Some(Self::SwellFifteenth2),
            40 => Some(Self::SwellMixtureV),
            41 => Some(Self::SwellContraOboe16),
            42 => Some(Self::SwellOboe8),
            43 => Some(Self::SwellDoubleTrumpet16),
            44 => Some(Self::SwellTrumpet8),
            45 => Some(Self::SwellClarion4),
            46 => Some(Self::SwellSpareAStopLine),
            47 => Some(Self::SwellSpareBStopLine),
            48 => Some(Self::GreatSoloToGreat),
            49 => Some(Self::GreatSwellToGreat),
            50 => Some(Self::GreatChoirToGreat),
            51 => Some(Self::GreatDoubleGeigen16),
            52 => Some(Self::GreatOpenDiapasonI8),
            53 => Some(Self::GreatOpenDiapasonII8),
            54 => Some(Self::GreatOpenDiapasonIII8),
            55 => Some(Self::GreatGeigen8),
            56 => Some(Self::GreatHohlFlute8),
            57 => Some(Self::GreatQuint5_1_3),
            58 => Some(Self::GreatOctave4),
            59 => Some(Self::GreatPrincipal4),
            60 => Some(Self::GreatWaldFlute4),
            61 => Some(Self::GreatOctaveQuint2_2_3),
            62 => Some(Self::GreatSuperOctave2),
            63 => Some(Self::GreatMixtureIII),
            64 => Some(Self::GreatMixtureV),
            65 => Some(Self::GreatSpareAStopLine),
            66 => Some(Self::GreatSpareBStopLine),
            67 => Some(Self::GreatContraTromba16),
            68 => Some(Self::GreatTromba8),
            69 => Some(Self::GreatOctaveTromba4),
            70 => Some(Self::SwellSubOctave),
            71 => Some(Self::SwellUnisonOff),
            72 => Some(Self::SwellOctave),
            73 => Some(Self::ChoirSoloToChoir),
            74 => Some(Self::ChoirSwellToChoir),
            75 => Some(Self::ChoirOpenDiapason8),
            76 => Some(Self::ChoirStoppedDiapason8),
            77 => Some(Self::ChoirPrincipal4),
            78 => Some(Self::ChoirStoppedFlute4),
            79 => Some(Self::ChoirNazard2_2_3),
            80 => Some(Self::ChoirSuperOctave2),
            81 => Some(Self::ChoirTierce1_3_5),
            82 => Some(Self::ChoirLarigot1_1_3),
            83 => Some(Self::ChoirTwentySecond1),
            84 => Some(Self::ChoirMixtureIII),
            85 => Some(Self::ChoirSpareUnenclosedStopLine),
            86 => Some(Self::ChoirDoubleDulciana16),
            87 => Some(Self::ChoirClaribelFlute8),
            88 => Some(Self::ChoirSalicional8),
            89 => Some(Self::ChoirVoxAngelica8),
            90 => Some(Self::ChoirDulciana8),
            91 => Some(Self::ChoirDulcet4),
            92 => Some(Self::ChoirClarinet8),
            93 => Some(Self::ChoirCornopean8),
            94 => Some(Self::ChoirSpareEnclosedStopLine),
            95 => Some(Self::ChoirContraTromba16),
            96 => Some(Self::ChoirTromba8),
            97 => Some(Self::ChoirOctaveTromba4),
            98 => Some(Self::ChoirTuba8),
            // 99 is deliberately not in the list
            // 100 is deliberately not in the list
            101 => Some(Self::PedalGreatToPedal),
            102 => Some(Self::PedalChoirToPedal),
            103 => Some(Self::PedalDoubleOpenWood32),
            104 => Some(Self::PedalOpenMetal16),
            105 => Some(Self::PedalOpenWoodI16),
            106 => Some(Self::PedalOpenWoodII16),
            107 => Some(Self::PedalViolone16),
            108 => Some(Self::PedalBourdon16),
            109 => Some(Self::PedalQuintaten16),
            110 => Some(Self::PedalViola16),
            111 => Some(Self::PedalDulciana16),
            112 => Some(Self::PedalOctaveMetal8),
            113 => Some(Self::PedalPrincipal8),
            114 => Some(Self::PedalOctaveWood8),
            115 => Some(Self::PedalFlute8),
            116 => Some(Self::PedalOctaveQuint5_1_3),
            117 => Some(Self::PedalSuperOctave4),
            118 => Some(Self::PedalFifteenth4),
            119 => Some(Self::PedalOctaveFlute4),
            120 => Some(Self::PedalMixtureIV),
            121 => Some(Self::PedalDoubleOphicleide32),
            122 => Some(Self::PedalOphicleide16),
            123 => Some(Self::PedalTrombone16),
            124 => Some(Self::PedalFagotto16),
            125 => Some(Self::PedalPosaune8),
            126 => Some(Self::PedalOctavePosaune4),
            _ => None, // invalid value (e.g., 2, or > 124)
        }
    }
}
